...
# Configs
resume_path = '/home/hpc/rlvl/rlvl129v/ControlNet/models/control_sd15_ini.ckpt'
batch_size = 4
logger_freq = 300
learning_rate = 1e-5
sd_locked = True
...
train_six_channels = True

# First use cpu to load models. Pytorch Lightning will automatically move it to GPUs.
model = create_model('/home/hpc/rlvl/rlvl129v/ControlNet/models/cldm_v15.yaml').cpu()

state_dict = load_state_dict(resume_path, location='cpu')

if train_six_channels == True:
